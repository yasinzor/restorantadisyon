...
public class signup extends javax.swing.JFrame {
   ...
   try{
    ...
    ResultSet rs1 = smt.executeQuery("select name,password from user");
    String Username=jTextField1.getText();
    String PassValue= new String (jPasswordField1.getPassword());
    if( rs1.getString("name").equals(Username)&& rs1.getString("password").equals(PassValue)){
       
       JOptionPane.showMessageDialog(rootPane, "Kaydınız basarı ile tamamlandı.");
    }
